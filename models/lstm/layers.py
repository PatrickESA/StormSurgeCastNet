"""
Adapted from https://github.com/TUM-LMF/MTLCC-pytorch/blob/master/src/models/convlstm/convlstm.py
authors: TUM-LMF
"""
...
class ConvLSTM_Seg(nn.Module):
    def __init__(
        ...
        self.convlstm_encoder = ConvLSTMlayer(
            input_dim=input_dim,
...
class BConvLSTM_Seg(nn.Module):
    def __init__(
        ...
        self.convlstm_forward = ConvLSTMlayer(
            input_dim=input_dim,
            input_size=input_size,
            hidden_dim=hidden_dim,
            kernel_size=kernel_size,
        ...
        self.convlstm_backward = ConvLSTMlayer(
            input_dim=input_dim,
            input_size=input_size,
            hidden_dim=hidden_dim,
            kernel_size=kernel_size,
